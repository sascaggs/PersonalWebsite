...
mod0 <- brm(data = d, family = gaussian(),
            body_mass_g ~ 1, 
            file = "~/Shane's Projects/Websites/Shane Scaggs/posts/2021-12-10-building-simple-multilevel-models/models/Model0-Intercept",
...
```{r, warning=F, echo=F, fig.width=4, fig.height=3, fig.cap='Posterior distribution of body mass (g).', fig.align='left'}
...
mod1a <- brm(data = d, family = gaussian(),
             body_mass_g ~ 1 + species, 
             file = "~/Shane's Projects/Websites/Shane Scaggs/posts/2021-12-10-building-simple-multilevel-models/Model1a-FixedSpecies",
             file_refit = 'on_change')
```
...
mod1b <- brm(data = d, family = gaussian(),
             body_mass_g ~ (1|species), 
             file = "~/Shane's Projects/Websites/Shane Scaggs/posts/2021-12-10-building-simple-multilevel-models/models/Model1b-RandomSpecies",
             file_refit = 'on_change')
```
...
mod2 <- brm(data = d, family = gaussian(),
             body_mass_g ~ (1+bill_length_s|species), 
             file = "~/Shane's Projects/Websites/Shane Scaggs/posts/2021-12-10-building-simple-multilevel-models/models/Model1b-RandomSlopes",
             file_refit = 'on_change')
```
...
#ggsave('lines.jpg', height = 3.1, width = 5.2, units = 'in', dpi=300)
```
